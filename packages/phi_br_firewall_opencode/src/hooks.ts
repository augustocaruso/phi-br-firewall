...
- Alguns tokens trazem uma legenda compacta depois de ":". Ela e contexto seguro para escrever melhor: [PACIENTE_001:full/upper] indica nome completo em caixa alta; [FAMILIAR_001:first/title] indica primeiro nome em title case; [DATA_010:T-19m/month-yyyy] indica cronologia relativa e formato original; [IDADE_007:school-age] indica faixa etaria.
...
- Para datas, T0 e o marco temporal do atendimento ou contexto. T-19m significa 19 meses antes; T+4m significa 4 meses depois; birth marca data de nascimento. Use cronologia relativa em linguagem natural ou mantenha o placeholder, opcionalmente com formato, como [DATA_010|date=month_year]. Nao invente datas absolutas.
